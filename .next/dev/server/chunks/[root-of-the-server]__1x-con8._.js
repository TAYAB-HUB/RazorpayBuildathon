...
"[project]/src/app/api/batches/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
[__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$runDetail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
async function GET(_req, context) {
    try {
        ...
        const id = params.id;
        const [batch] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].select().from(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["batches"]).where((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$conditions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["eq"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["batches"].id, id)).limit(1);
        if (!batch) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "batch not found"
        }, {
            status: 404
        });
        const latest = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$runDetail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["latestRunForBatch"])(id);
        const runsCount = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$runDetail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["countRunsForBatch"])(id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1x-con8._.js.map